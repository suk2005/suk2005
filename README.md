...
![Pivot Tables](https://img.shields.io/badge/Pivot%20Tables-217346?logo=microsoftexcel&logoColor=white)
...
![Statsmodels](https://img.shields.io/badge/Statsmodels-4051B5?logo=python&logoColor=white)
...
![NLP](https://img.shields.io/badge/NLP-lightgrey)
...
1. 💳 [Online Payment Database System](https://github.com/suk2005/Online_Payment_Database_System): A MySQL-based database system for managing customers, accounts, merchants, payment methods, transactions, and refunds.
2. 🚗 [Smart Parking System](https://github.com/suk2005/smart-vehicles-parking-system): A smart vehicle parking management system built using React and Node.js.
3. 🤖 [AI Chatbot](https://github.com/suk2005/chatbot): A personal AI chatbot developed using Python for interactive conversations and assistance.
4. 📊 [Sorting Visualizer](https://github.com/suk2005/sorting-visualizer): A visual tool that demonstrates sorting algorithms such as Bubble Sort, Selection Sort, Insertion Sort, and more.
5. 🏦 [Bank Loan Application Dashboard](https://github.com/suk2005/Banking_Loan_Application_Dashboard): An advanced Excel dashboard for analyzing bank loan applications, loan performance, and key business insights.
